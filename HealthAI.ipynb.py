...
Original file is located at
    https://colab.research.google.com/drive/1GFgTOhymHMmqF9TVATBpZrfG5nJ9iXoG
"""
...
def disease_prediction(symptoms):
    prompt = f"Based on the following symptoms, provide possible medical conditions and general meditation suggestions. Always emphasize that this is not a substitute for professional medical advice. Symptoms: {symptoms}"
    return generate_response(prompt, max_length=1200)

def treatment_plan(condition, age, gender, medical_history):
    prompt = f"Generate personalized treatment suggestions for the following patient information. Include home remedies and general medical advice. Patient Information: Condition: {condition}, Age: {age}, Gender: {gender}, Medical History: {medical_history}"
            ...
            with gr.Row():
                with gr.Column():
                    condition_input = gr.Textbox(label="Medical Condition",
                                                 placeholder="e.g., diabetes, hypertension, asthma...", lines=2)
                    ...
                    history_input = gr.Textbox(label="Medical History",
                                               placeholder="e.g., Previous conditions, allergies, medications...", lines=3)
